...
void Rainbowduino::cubeSet(unsigned char x, unsigned char y, unsigned char z, rgb_t rgb) {

  setPixelXY(ZX[z][x], YX[y][x], rgb.color[red], rgb.color[green], rgb.color[blue]);
